...
// 	artwork.setAttribute("style", "background:url(ressources/images/logo/disk_33trs.png), url('"+playlist[currentSong]['artwork']+"') center no-repeat;");
// 	music.innerHTML = '<source src="audios/2012/2012-10-21-Temoignage a propos de Germaine - Gobelins.mp3" type="audio/mp3">';
...
// 	artist.innerHTML = playlist[currentSong]['artist'];
// 	artist.title = playlist[currentSong]['artist'];
// 	artwork.setAttribute("style", "transform: rotate("+rot+"deg); background:url(ressources/images/logo/disk_33trs.png), url('"+playlist[currentSong]['artwork']+"') center no-repeat;");
// 	music.load();
